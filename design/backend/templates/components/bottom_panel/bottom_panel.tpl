    ...
    <div id="bp_bottom_panel"
        ...
        {if $smarty.const.ACCOUNT_TYPE === "customer"}
            <div class="bp-modes">
                ...
                {/if}
                {if fn_check_permissions("customization", "update_mode", "admin", "", ["type" => "theme_editor"], $smarty.const.AREA, $auth.user_id) && $auth.user_type === "UserTypes::ADMIN"|enum}
                ...
                {/if}
                {if fn_check_permissions("customization", "update_mode", "admin", "", ["type" => "block_manager"], $smarty.const.AREA, $auth.user_id) && $auth.user_type === "UserTypes::ADMIN"|enum}
