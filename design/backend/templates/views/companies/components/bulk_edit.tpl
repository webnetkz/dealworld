...
>
    ...
    <ul class="btn-group bulk-edit__wrapper">
        {hook name="companies:bulk_edit_items"}
            <li class="btn bulk-edit__btn bulk-edit__btn--check-items">
                ...
                {include file="common/check_items.tpl"
                    ...
                    check_statuses="companies"|fn_get_predefined_statuses:$company.status
                }
            </li>
            ...
            {if !$runtime.company_id}
                <li class="btn bulk-edit__btn bulk-edit__btn--status dropleft-mod">
                    ...
                    <ul class="dropdown-menu">
                        {include file="views/companies/components/bulk_edit/status.tpl"}
                    </ul>
                </li>
            {/if}
            ...
            <li class="btn bulk-edit__btn bulk-edit__btn--actions dropleft-mod">
                ...
                <ul class="dropdown-menu">
                    {include file="views/companies/components/bulk_edit/actions.tpl"}
                </ul>
            </li>
        {/hook}
    </ul>
