    ...
    var methods = {
            ...
            if (e.type == 'click') {
                if (jelm.closest('.cm-icon-live-edit').length) {
                    ...
                    live_editor_obj = {
                        ...
                        object_id   : t_elm.data('caLiveEditorObjectId'),
                        object_type : t_elm.data('caLiveEditorObjectType')
                    };
        ...
        load: function(content) {
            ...
            $('[data-ca-live-editor-obj]', content).each(function() {
                var elm = $(this),
                    ...
                    object_id = elm.data('caLiveEditorObjectId'),
                    object_type = elm.data('caLiveEditorObjectType');
                ...
                if (object_id) {
                    obj_phrase_attr += ' data-ca-live-editor-object-id="' + object_id + '"';
                }

                if (object_type) {
                    obj_phrase_attr += ' data-ca-live-editor-object-type="' + object_type + '"';
                }
        ...
        save: function(value) {
            var data = {
                ...
                object_id   : live_editor_obj.object_id,
                object_type : live_editor_obj.object_type
            };
