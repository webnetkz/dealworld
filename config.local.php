...
$config['db_name'] = 'dealworld';
$config['db_user'] = 'admin';
$config['db_password'] = 'fepipe7611!!QQ';
...
$config['http_host'] = 'dealworld.shop';
$config['http_path'] = '';

// Host and directory where software is installed on secure server
$config['https_host'] = 'dealworld.shop';
$config['https_path'] = '';
...
$config['admin_index']    = 'mypanel.php';
